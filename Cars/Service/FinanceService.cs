...
namespace Cars.Service
{
    public class FinanceService
    {
        ...
        {
            var result = await _context.OrderDetails.Where(x => x.OrderDetailsID == orderDetailsID).Include(x => x.Finance).ThenInclude(x => x.FinanceDocument).FirstOrDefaultAsync();
            return result;
        }
